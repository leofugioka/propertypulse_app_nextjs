              ...
              <div className="relative ml-3">
                <div>
                  ...
                  >
                    ...
                    <Image className="h-8 w-8 rounded-full" src={session.user?.image ?? profileImg} alt="" width={0} height={0} sizes="100vw" />
                  </button>
                </div>
                ...
                {isProfileMenuOpen && (
                  ...
                  >
                    ...
                    <form action={actions.signOut}>
                      <button className="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabIndex={-1} id="user-menu-item-2" type="submit">
                        Sign Out
                      </button>
                    </form>
                  </div>
